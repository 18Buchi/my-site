  ...
  $(function () {
    for (let i = 0; i < items.length; i++) {
      $("<img>")
        ...
        .addClass(
          "card-img-top shadow-sm p-3 mt-5 mb-1 bg-white rounded position-relative outLinkBtn"
        )
        .appendTo(".c-items");
      $("<h5>")
        ...
        .appendTo(".c-items");
      $("<a>")
        .addClass("btn btn-secondary d-inline-block float-end btn-sm  mt-1 outLinkBtn")
        .text("詳細を見る!!")
